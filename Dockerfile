...
# cleanup
RUN apt-get remove --autoremove --purge -y gtk-doc-tools libde265-dev libfontconfig1-dev libfreetype6-dev libgif-dev libsdl1.2-dev libtiff5-dev libtool libxml2-utils meson ninja-build swig yasm
