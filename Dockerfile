...
# cleanup
RUN pip3 uninstall -y meson && apt-get remove --autoremove --purge -y gtk-doc-tools libfontconfig1-dev libfreetype6-dev libgif-dev libgirepository1.0-dev libsdl1.2-dev libtiff5-dev libtool libxml2-utils swig yasm ninja-build python3-pip bc
